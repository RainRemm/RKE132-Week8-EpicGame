...
//string[] heroes = {"Superman", "Batman", "Wonder Woman", "Nicolas Cage"};
//string[] villians = {"Joker", "The Shark", "ToomasTheTank", "KalviKalle"};
//string[] weapon = { "labata", "lusikas", "pulk", "katelok", "kompensaator" };
